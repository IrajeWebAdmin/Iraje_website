    ...
    <section className="bg-[#BDD1FE29] py-16">
      ...
      <div className="container-global">
        ...
        <div className="mx-auto max-w-6xl text-center">
          ...
          <span className="text-4xl font-semibold  text-[#0451CC]">
            Trust & Compliance
          </span>

          <h2 className="mt-4 text-5xl font-semibold text-black lg:text-6xl">
            Security you can verify
          </h2>

          <p className="mx-auto mt-10 max-w-4xl text-center text-[24px]  text-[#B8B8B8]">
