...
// Footer for the Certification page — logo lockup, three link columns
// (Certifications / Program / Iraje) and a bottom bar. Link content lives in
// certification.footer.
export default function CertFooter() {
  const { columns, copyright, tag } = certification.footer;
